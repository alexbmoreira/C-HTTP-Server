...
** Code downloaded from 'https://beej.us/guide/bgnet/examples/server.c'
** Edited code marked below with a comment
*/
...
int main(void)
{
	...
	{
		/*
		** Code in this loop is mostly from beej, but a lot has been altered by me
		*/
